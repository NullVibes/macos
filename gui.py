...
def app_layout(self):
    ...
    ttk.Separator(master=self, orient='horizontal', style='TSeparator', width=5).grid(row=2, column=0, columnspan=(i+1), sticky=E+W, pady=0, padx=5, ipadx=0, ipady=0)
    print(s.configure('TSeparator'))
